...
$m\times p$ matrix where $z_{ij}=\boldsymbol{x}_{i\cdot}\boldsymbol{w}_{\cdot j}$
...
\begin{eqnarray*}
z_{11} & = & \boldsymbol{x}_{1\cdot}\boldsymbol{w}_{\cdot1}\\
 & = & \left(1\cdot13\right)+\left(2\cdot15\right)+\left(3\cdot17\right)+\left(4\cdot19\right)=170
\end{eqnarray*}
}and similarly
\begin{eqnarray*}
z_{21} & = & \boldsymbol{x}_{2\cdot}\boldsymbol{w}_{\cdot1}\\
