...
In the unbalanced case taking the average of the cell means produces a different answer than taking the average of the data. The `lsmeans` package choses to take the average of the cell means.
